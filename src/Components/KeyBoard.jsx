...
export const KeyBoard = (props) => {
  return (
    <div className='keyboard-container'>
      ...
      <button className="black-key" value="Eb3" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "94px"}}>Eb3</button>
      ...
      <button className="black-key" value="Db4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "413.2px"}}>Db4</button>

      <button className='white-key' value="D4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease}>D4</button>

      <button className="black-key" value="Eb4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "469.2px"}}>Eb4</button>
      ...
      <button className="black-key" value="Gb4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "575.2px"}}>Gb4</button>

      <button className='white-key' value="G4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease}>G4</button>

      <button className="black-key" value="Ab4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "628.2px"}}>Ab4</button>

      <button className='white-key' value="A4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease}>A4</button>

      <button className="black-key" value="Bb4" onMouseDown={props.handleClick} onMouseUp={props.handleRelease} style={{left: "682.2px"}}>Bb4</button>
